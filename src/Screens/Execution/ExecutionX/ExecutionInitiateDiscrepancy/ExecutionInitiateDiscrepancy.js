...
function ExecutionInitiateDiscrepancy() {
  ...
  return (
    <>
      <Stack alignItems="center" direction="row" spacing={2}>
        ...
        >
          Initiate Standalone Discrepancy
        </Button>
        {initiated ? (
          <Chip color="info" label="Initiated Discrepancy" />
        ) : (
          <Chip color="error" label="Initiate Discrepancy" />
        )}
      </Stack>
